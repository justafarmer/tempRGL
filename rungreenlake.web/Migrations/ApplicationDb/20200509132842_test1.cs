        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_RunGreenLakeUsers_ProfileID", x => x.ProfileID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profiles_RunGreenLakeUsers_ProfileID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuddyList", x => new { x.FirstID, x.SecondID });
                    table.ForeignKey(
                        name: "FK_BuddyList_Profiles_FirstID",
                        column: x => x.FirstID,
                    ...
                    table.ForeignKey(
                        name: "FK_BuddyList_Profiles_SecondID",
                        column: x => x.SecondID,
                        principalTable: "Profiles",
                        principalColumn: "ProfileID");
                });
